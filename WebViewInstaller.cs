...
internal class WebViewInstaller : IDepInstaller
{
    ...
    const string WebViewKey = @"SOFTWARE\WOW6432Node\Microsoft\EdgeUpdate\Clients\{F3017226-FE2A-4295-8BDF-00C3A9A7E4C5}";
    ...
    {
        var key = Registry.LocalMachine.OpenSubKey(WebViewKey);
